...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('stats/proyectos', [\App\Http\Controllers\StatsController::class, 'proyectos']);
    Route::get('stats/tareas', [\App\Http\Controllers\StatsController::class, 'tareas']);
