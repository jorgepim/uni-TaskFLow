...
```java
private static final String BASE_URL_WIFI = "http://192.168.18.31:8000/api"; // IP WiFi
private static final String BASE_URL_EMULATOR = "http://127.0.0.1:8000/api"; // Emulador
